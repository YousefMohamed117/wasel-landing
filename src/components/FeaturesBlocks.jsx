      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-white" dir="rtl">
              لماذا تنضم لواصل؟
            </h2>
            <p className="text-xl text-gray-400" dir="rtl">
              منصة واصل توفر لك الأدوات والفرص التي تحتاجها لتنمية عملك والوصول
              لعملاء جدد
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            {/* 1st item - Platform combines local & freelancers */}
            <div
            ...
            {/* 2nd item - Greater work opportunities */}
            <div
              className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl"
              dir="rtl"
            >
            ...
            >
              ...
              <p className="text-gray-600 text-center">
                تواصل مباشر مع العملاء المهتمين بخدماتك دون وسطاء
              </p>
            </div>

            {/* 4th item - Clear request system */}
            <div
              className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl"
              dir="rtl"
            >
              ...
              <p className="text-gray-600 text-center">
                إدارة الطلبات والمشاريع بطريقة منظمة وسهلة
              </p>
            </div>

            {/* 5th item - Professional profile */}
            <div
              className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl"
              dir="rtl"
            >
              ...
              <p className="text-gray-600 text-center">
                عرض خدماتك وأعمالك السابقة بشكل احترافي وجذاب
              </p>
            </div>

            {/* 6th item - Growth & expansion */}
            <div
              className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl"
              dir="rtl"
            >
              ...
              <p className="text-gray-600 text-center">
                فرص لتطوير عملك وزيادة دخلك باستمرار
              </p>
            </div>
          </div>
        </div>
